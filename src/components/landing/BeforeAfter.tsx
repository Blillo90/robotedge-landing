    ...
    <section className="py-28 px-6" style={{ background: '#F7F5F2' }}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-14 max-w-xl">
          ...
          >
            Lo que cambia cuando dejas de operar con emociones
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-px" style={{ background: 'rgba(0,0,0,0.06)' }}>
          ...
          <div className="p-8 md:p-10" style={{ background: '#FFFFFF' }}>
            <div className="flex items-center gap-3 mb-7">
              ...
              <h3
                ...
                style={{ fontSize: '1rem', color: '#141412' }}
              >
                Antes del curso
              </h3>
            </div>
          ...
          <div
            ...
            style={{ background: '#FFFFFF', borderLeft: '2px solid rgba(5,150,105,0.15)' }}
          >
            <div className="flex items-center gap-3 mb-7">
              <span
                className="w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold shrink-0"
            ...
            <ul className="flex flex-col gap-4" role="list">
              {afterItems.map((item) => (
                <li key={item} className="flex items-start gap-3">
                  ...
                  <span className="text-sm leading-relaxed font-medium" style={{ color: '#141412' }}>
                    {item}
                  </span>
                </li>
              ))}
